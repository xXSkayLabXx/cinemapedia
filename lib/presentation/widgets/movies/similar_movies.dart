...
final similarMoviesProvider = FutureProvider.family((ref, int movieId) {
  final movieReposiroty = ref.watch(movieRepositoryProvider);
  return movieReposiroty.getSimiliarMovies(movieId);
});
...
class SimilarMovies extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return similarMoviesFuture.when(
      ...
      error: (_,__)=> const Center(child: Text('No se pudo cargar películas similare'),),
