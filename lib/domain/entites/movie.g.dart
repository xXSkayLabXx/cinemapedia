...
const MovieSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'originalLenguage': PropertySchema(
      id: 4,
      name: r'originalLenguage',
      type: IsarType.string,
    ),
...
int _movieEstimateSize(
  ...
  bytesCount += 3 + object.originalLenguage.length * 3;
...
void _movieSerialize(
  ...
  writer.writeString(offsets[4], object.originalLenguage);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    originalLenguage: reader.readString(offsets[4]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'originalLenguage',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originalLenguageIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'originalLenguage',
        value: '',
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByOriginalLenguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalLenguage', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByOriginalLenguageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalLenguage', Sort.desc);
    });
  }
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByOriginalLenguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalLenguage', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByOriginalLenguageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalLenguage', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByOriginalLenguage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'originalLenguage',
          caseSensitive: caseSensitive);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, String, QQueryOperations> originalLenguageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'originalLenguage');
    });
  }
